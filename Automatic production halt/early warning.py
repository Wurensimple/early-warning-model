...
for idx, probabilities in enumerate(final_probabilities_all):
    if probabilities is not None:
        ...
        cond_1 = threshold_value_down > data_normalized[idx, 0]
        cond_2 = threshold_value_down > data_normalized[idx, 1]
        cond_3 = threshold_value_down > data_normalized[idx, 2]
        cond_4 = threshold_value_down > data_normalized[idx, 3]
        cond_5 = threshold_value_down > data_normalized[idx, 4]
        if sum_1 < sum_2 and cond_1 and cond_3 and cond_4 and cond_5:
